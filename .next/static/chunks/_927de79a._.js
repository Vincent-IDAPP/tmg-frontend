...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sessionProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/sessionProvider.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LoginPage() {
    ...
    /* const { login, logout } = useSessionContext(); */ /* useEffect(() => {
    if(session){
      router.push("/")
      
    }
    console.log(session)
  }, [login, session]); */ async function handleSubmit(e) {
        e.preventDefault();
        setLoading(true);
        setError(null);
        try {
...
//# sourceMappingURL=_927de79a._.js.map